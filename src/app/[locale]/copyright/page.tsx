...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - The Mermaid Mask Wiki',
    description: 'Copyright and intellectual property information for The Mermaid Mask Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - The Mermaid Mask Wiki',
      description: 'Copyright and intellectual property information for The Mermaid Mask Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 The Mermaid Mask Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of The Mermaid Mask Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              The Mermaid Mask Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>SFB Games</strong> - Developer and publisher of The Mermaid Mask</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>The Mermaid Mask</strong> - Trademark of SFB Games</li>
              <li><strong>The Mermaid Mask Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with The Mermaid Mask Wiki.
            </p>
            ...
            <p>
              ...
              The Mermaid Mask Wiki<br />
              Email: <a href="mailto:dmca@themermaidmask.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@themermaidmask.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "The Mermaid Mask Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: The Mermaid Mask Wiki (themermaidmask.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@themermaidmask.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@themermaidmask.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@themermaidmask.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@themermaidmask.wiki</a>
            </p>
            <p>
