...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - The Mermaid Mask Wiki",
    description: "Read the Terms of Service for The Mermaid Mask Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - The Mermaid Mask Wiki",
      description: "Terms and conditions for using The Mermaid Mask Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using The Mermaid Mask Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using The Mermaid Mask Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and The Mermaid Mask Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              The Mermaid Mask Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "The Mermaid Mask". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Walkthrough and puzzle guides</li>
              <li>Clue and evidence guides</li>
              <li>Mortuga submarine location maps</li>
              <li>Suspect and character profiles</li>
              <li>Achievement walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> The Mermaid Mask Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam), Sony Interactive Entertainment, Nintendo, or SFB Games (the developer of The Mermaid Mask). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by The Mermaid Mask Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam), Sony Interactive Entertainment, Nintendo, and/or SFB Games (the developer of The Mermaid Mask). We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, THE MERMAID MASK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and The Mermaid Mask Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@themermaidmask.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@themermaidmask.wiki</a>
            </p>
            <p>
