...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - The Mermaid Mask Wiki',
    description: 'The Mermaid Mask Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Mermaid Mask Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              The Mermaid Mask Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam), Sony Interactive Entertainment, Nintendo, or SFB Games (the developer of The Mermaid Mask). All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@themermaidmask.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@themermaidmask.wiki</a>
            </p>
            <p>
